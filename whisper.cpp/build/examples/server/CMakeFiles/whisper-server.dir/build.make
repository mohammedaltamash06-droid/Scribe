...
examples/server/CMakeFiles/whisper-server.dir/server.cpp.o: /workspaces/Scribe/whisper.cpp/examples/server/server.cpp
examples/server/CMakeFiles/whisper-server.dir/server.cpp.o: examples/server/CMakeFiles/whisper-server.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/workspaces/Scribe/whisper.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/server/CMakeFiles/whisper-server.dir/server.cpp.o"
	cd /workspaces/Scribe/whisper.cpp/build/examples/server && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT examples/server/CMakeFiles/whisper-server.dir/server.cpp.o -MF CMakeFiles/whisper-server.dir/server.cpp.o.d -o CMakeFiles/whisper-server.dir/server.cpp.o -c /workspaces/Scribe/whisper.cpp/examples/server/server.cpp
...
examples/server/CMakeFiles/whisper-server.dir/server.cpp.i: cmake_force
	...
	cd /workspaces/Scribe/whisper.cpp/build/examples/server && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspaces/Scribe/whisper.cpp/examples/server/server.cpp > CMakeFiles/whisper-server.dir/server.cpp.i
...
examples/server/CMakeFiles/whisper-server.dir/server.cpp.s: cmake_force
	...
	cd /workspaces/Scribe/whisper.cpp/build/examples/server && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspaces/Scribe/whisper.cpp/examples/server/server.cpp -o CMakeFiles/whisper-server.dir/server.cpp.s
...
bin/whisper-server: src/libwhisper.so.1.7.6
...
bin/whisper-server: examples/server/CMakeFiles/whisper-server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/workspaces/Scribe/whisper.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/whisper-server"
	cd /workspaces/Scribe/whisper.cpp/build/examples/server && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/whisper-server.dir/link.txt --verbose=$(VERBOSE)
...
examples/server/CMakeFiles/whisper-server.dir/clean:
	cd /workspaces/Scribe/whisper.cpp/build/examples/server && $(CMAKE_COMMAND) -P CMakeFiles/whisper-server.dir/cmake_clean.cmake
.PHONY : examples/server/CMakeFiles/whisper-server.dir/clean

examples/server/CMakeFiles/whisper-server.dir/depend:
	cd /workspaces/Scribe/whisper.cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspaces/Scribe/whisper.cpp /workspaces/Scribe/whisper.cpp/examples/server /workspaces/Scribe/whisper.cpp/build /workspaces/Scribe/whisper.cpp/build/examples/server /workspaces/Scribe/whisper.cpp/build/examples/server/CMakeFiles/whisper-server.dir/DependInfo.cmake "--color=$(COLOR)"
